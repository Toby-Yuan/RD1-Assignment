...
class updateTwo extends database{

    public function __construct(){
        $deleteAll = self::query("DELETE FROM twoDay");
    }

    public function update($city){
        $json_url = "https://opendata.cwb.gov.tw/api/v1/rest/datastore/F-D0047-089?Authorization=CWB-6DBF737A-A676-4BC9-A35B-334E259FB4D2&locationName=" . $city . "&elementName=PoP12h&elementName=Wx&elementName=T";
